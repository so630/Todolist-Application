...
mongoose.connect('mongodb+srv://<admin>:<password>@cluster0.rgrzw.mongodb.net/todolist-v2DB', {useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false})
